...
This page covers translation files, generation and developer APIs. Language selection is described in [本体と操作の設定](../device-settings-ja.md#言語とフォント). UI fonts and SD reading fonts are separate.
